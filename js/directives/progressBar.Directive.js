    ...
    angular
        ...
        .directive("progressBar", ["$timeout", function ($timeout) {
            return {
                ...
                template: ' <div> \
                                <div class="progress"> \
                                    <div class="progress-bar ng-class:{\'progress-bar-completed\': isCompleted };"  aria-valuenow="{{complete}}" aria-valuemin="0" aria-valuemax="{{total}}" ng-style="{ width: progress*100 + \'%\' }"></div> \
                                </div> \
